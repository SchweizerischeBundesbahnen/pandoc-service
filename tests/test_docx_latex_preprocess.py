...
from app import DocxColorPreProcess, DocxLatexPreProcess, DocxListLevelPreProcess, DocxParagraphPreProcess
...
def test_single_pass_matches_sequential_preprocessors():
    ...
    sequential = DocxListLevelPreProcess.preprocess(DocxParagraphPreProcess.preprocess(DocxColorPreProcess.preprocess(blob)))
